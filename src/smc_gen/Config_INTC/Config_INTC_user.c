...
* Return Value : None
***********************************************************************************************************************/
#pragma interrupt r_Config_INTC_intp0_interrupt(enable=false, channel=37, fpu=true, callt=false)
...
* Return Value : None
***********************************************************************************************************************/
#pragma interrupt r_Config_INTC_intp1_interrupt(enable=false, channel=38, fpu=true, callt=false)
