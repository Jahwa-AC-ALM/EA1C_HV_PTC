...
void R_Config_ADCA0_Create(void)
{
    ...
    INTC1.ICADCA0I0.UINT16 &= _INT_PRIORITY_LEVEL14;
    /* Set ADC0 virtual channel setting */
    ADCA0.VCR00.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_DISABLE | _ADC_LIMIT_TABLE_SELECT_1 | 
                         _ADC_PHYSICAL_CHANNEL_ANI00;
    ADCA0.VCR01.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_DISABLE | _ADC_LIMIT_TABLE_SELECT_NONE | 
                         _ADC_PHYSICAL_CHANNEL_ANI01;
    ADCA0.VCR02.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_DISABLE | _ADC_LIMIT_TABLE_SELECT_NONE | 
                         _ADC_PHYSICAL_CHANNEL_ANI02;
    ADCA0.VCR03.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_DISABLE | _ADC_LIMIT_TABLE_SELECT_NONE | 
                         _ADC_PHYSICAL_CHANNEL_ANI03;
    ADCA0.VCR04.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_DISABLE | _ADC_LIMIT_TABLE_SELECT_NONE | 
                         _ADC_PHYSICAL_CHANNEL_ANI04;
    ADCA0.VCR05.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_DISABLE | _ADC_LIMIT_TABLE_SELECT_NONE | 
                         _ADC_PHYSICAL_CHANNEL_ANI05;
    ADCA0.VCR06.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_DISABLE | _ADC_LIMIT_TABLE_SELECT_NONE | 
                         _ADC_PHYSICAL_CHANNEL_ANI06;
    ADCA0.VCR07.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_DISABLE | _ADC_LIMIT_TABLE_SELECT_NONE | 
                         _ADC_PHYSICAL_CHANNEL_ANI07;
    ADCA0.VCR08.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_DISABLE | _ADC_LIMIT_TABLE_SELECT_NONE | 
                         _ADC_PHYSICAL_CHANNEL_ANI16;
    ADCA0.VCR09.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_DISABLE | _ADC_LIMIT_TABLE_SELECT_NONE | 
                         _ADC_PHYSICAL_CHANNEL_ANI17;
    ADCA0.VCR10.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_DISABLE | _ADC_LIMIT_TABLE_SELECT_NONE | 
                         _ADC_PHYSICAL_CHANNEL_ANI18;
    ADCA0.VCR11.UINT32 = _ADC_MPX_DISABLE | _ADC_VIRTUAL_CHANNEL_END_INT_ENABLE | _ADC_LIMIT_TABLE_SELECT_NONE | 
                         _ADC_PHYSICAL_CHANNEL_ANI19;
    /* Set ADC0 operation setting */
    ADCA0.ADCR.UINT32 = _ADC_ASYNC_SUSPEND | _ADC_12_BIT_MODE | _ADC_RIGHT_ALIGNED;
    ...
    ADCA0.DGCTL0.UINT32 = _ADC_SELF_DIAG_VOLTAGE_LEVEL_7;
