...
extern void r_Config_PWMTMR_interrupt(void);
...
extern void r_Config_PWMZ1_channel8_interrupt(void);
...
/* External interrupt; */
extern void r_Config_INTC_intp0_interrupt(void);
/* External interrupt; */
extern void r_Config_INTC_intp1_interrupt(void);
/* External interrupt; */
...
/* External interrupt; */
extern void r_Config_INTC_intp11_interrupt(void);
...
extern void r_Config_PWMZ1_channel9_interrupt(void);
...
void * const INT_Vectors[] = {
    ...
    (void *)eiint7,
    /* Interrupt for CH0 of TAUD0; */
    (void *)vISRWrapper,			//r_Config_PWMTMR_interrupt,
    /* Interrupt for CH2 of TAUD0; */
    (void *)eiint9,
    /* Interrupt for CH4 of TAUD0; */
    (void *)eiint10,
    ...
    (void *)eiint11,
    /* Interrupt for CH8 of TAUD0; */
    (void *)r_Config_PWMZ1_channel8_interrupt,
    /* Interrupt for CH10 of TAUD0; */
    (void *)eiint13,
    /* Interrupt for CH12 of TAUD0; */
    (void *)eiint14,
    ...
    (void *)eiint17,
    /* ADCA0 SG1 end interrupt; */
    (void *)vISRWrapper,			//r_Config_ADCA0_scan_group1_end_interrupt,
    /* ADCA0 SG2 end interrupt; */
    (void *)eiint19,
    /* ADCA0 SG3 end interrupt; */
    (void *)eiint20,
    ...
    (void *)vISRWrapper,//vISRWrapper, 		//R_RSCAN_ReadRx,
    /* CAN0 error interrupt; */
    (void *)vISRWrapper,//vISRWrapper, 		//R_RSCAN_Error,
    ...
    (void *)eiint33,
    /* RLIN30 transmit interrupt; */
    (void *)vISRWrapper,				//r_Config_UART0_interrupt_send,
    /* RLIN30 receive complete interrupt; */
    (void *)vISRWrapper,				//r_Config_UART0_interrupt_receive,
    /* RLIN30 status interrupt; */
    (void *)vISRWrapper,				//r_Config_UART0_interrupt_error,
    /* External interrupt; */
    (void *)vISRWrapper,				//r_Config_INTC_intp0_interrupt,
    /* External interrupt; */
    (void *)vISRWrapper,				//r_Config_INTC_intp1_interrupt,
    /* External interrupt; */
    (void *)eiint39,
    /* WDTA0 75% interrupt; */
    ...
    (void *)eiint42,
    /* External interrupt; */
    (void *)OsDispatcher,//OsDispatcher_isr,
    /* External interrupt; */
    (void *)eiint44,
    /* External interrupt; */
    (void *)eiint45,
    ...
    (void *)eiint46,
    /* External interrupt; */
    (void *)r_Config_INTC_intp11_interrupt,
    /* Interrupt for TAUD0 channel 1; */
    (void *)eiint48,
    /* Interrupt for TAUD0 channel 3; */
    (void *)eiint49,
    ...
    (void *)eiint51,
    /* Interrupt for TAUD0 channel 9; */
    (void *)r_Config_PWMZ1_channel9_interrupt,
    /* Interrupt for TAUD0 channel 11; */
    (void *)eiint53,
    /* Interrupt for TAUD0 channel 13; */
    (void *)eiint54,
    ...
    (void *)eiint83,
    /* OSTM0 interrupt; */
    (void *)vISRWrapper,	//vISRWrapper   r_Config_OSTM0_interrupt
    /* ENCA0 overflow interrupt; */
    (void *)eiint85,
    /* ENCA0 underflow interrupt; */
    (void *)eiint86,
